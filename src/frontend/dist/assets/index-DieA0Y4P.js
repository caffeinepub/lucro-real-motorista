...
function DaySummary({ rides, onFinishDay, onBack }) {
  ...
  const bestPlatform = platformStats.length > 0 ? platformStats.reduce((best, cur) => cur.net > best.net ? cur : best) : null;
  const maxBarNet = platformStats.length > 0 ? Math.max(...platformStats.map((s) => Math.max(s.net, 0))) : 0;
  const statsValues = {
    gross: formatBRL(totalGross),
    fees: formatBRL(totalFees),
    cost: formatBRL(totalCost)
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-screen", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "aria-label": "Voltar",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 16, style: { color: "oklch(0.68 0.025 225)" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-foreground", children: "Resumo do Dia" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto px-5 pb-36 pt-5", children: rides.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-semibold text-foreground mb-1", children: "Sem dados ainda" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "oklch(0.68 0.025 225)" }, children: "Adicione corridas para ver o resumo financeiro." })
        ]
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: STATS_ITEMS.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
      ...
      platformStats.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-foreground mb-4", children: "Lucro por Plataforma" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: platformStats.map((stat) => {
              const isBest = (bestPlatform == null ? void 0 : bestPlatform.platform) === stat.platform;
              const barWidth = maxBarNet > 0 ? Math.max(stat.net / maxBarNet * 100, 4) : 4;
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            style: {
                              ...
                              color: stat.platform === "uber" ? "oklch(0.10 0 0)" : "oklch(0.98 0 0)"
                            },
                            children: stat.platform === "uber" ? "U" : stat.platform === "99" ? "9" : "i"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: PLATFORM_LABELS[stat.platform] }),
                        isBest && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "text-sm font-bold",
                          style: {
                            color: isBest ? "oklch(0.91 0.22 125)" : "oklch(0.94 0.01 240)"
                          },
                          children: formatBRL(stat.net)
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            style: {
                              width: `${barWidth}%`,
                              background: isBest ? "oklch(0.91 0.22 125)" : PLATFORM_ACCENT[stat.platform]
                            }
                          }
                        )
                      }
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: { background: "oklch(0.19 0.026 245)" },
                children: "Detalhamento por Plataforma"
              }
            ),
            platformStats.map((stat, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "px-4 py-3",
                  style: {
                    background: isBest ? "oklch(0.91 0.22 125 / 0.06)" : i % 2 === 0 ? "oklch(0.16 0.022 242)" : "oklch(0.14 0.02 242)",
                    borderTop: i > 0 ? "1px solid oklch(0.24 0.025 245)" : void 0
                  },
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: PLATFORM_LABELS[stat.platform]
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "text-sm font-bold",
                          style: {
                            color: isBest ? "oklch(0.91 0.22 125)" : stat.net >= 0 ? "oklch(0.94 0.01 240)" : "oklch(0.65 0.22 22)"
                          },
                          children: formatBRL(stat.net)
                        }
                      )
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium text-foreground", children: formatBRL(stat.gross) })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: "linear-gradient(to top, oklch(0.10 0.015 240) 70%, transparent)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
...
function RideEntry({
  ...
  const [grossValue, setGrossValue] = reactExports.useState("");
  ...
  const isValid = grossValue && km && platform && Number.parseFloat(grossValue.replace(",", ".")) > 0 && Number.parseFloat(km.replace(",", ".")) > 0;
  const handleAdd = () => {
    ...
    setKm("");
    setPlatform(null);
    ue.success(`Corrida adicionada! Lucro: ${formatBRL(net)}`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 16, style: { color: "oklch(0.68 0.025 225)" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 14, style: { color: "oklch(0.91 0.22 125)" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "oklch(0.68 0.025 225)" }, children: "Lucro do Dia" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "text-sm font-bold",
                      style: {
                        color: rides.length > 0 ? "oklch(0.91 0.22 125)" : "oklch(0.68 0.025 225)"
                      },
                      children: formatBRL(totalNetProfit)
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14, style: { color: "oklch(0.68 0.025 225)" } })
              ]
            }
          )
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 overflow-y-auto px-5 pb-32", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground mt-5 mb-5", children: "Registrar Corrida" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "label",
            {
              ...
              style: { color: "oklch(0.68 0.025 225)" },
              children: "Valor Bruto da Corrida"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["uber", "99", "indrive"].map((p) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: {
                    background: isSelected ? "oklch(0.16 0.022 242)" : "oklch(0.13 0.02 240)",
                    borderColor: isSelected ? "oklch(0.91 0.22 125)" : "oklch(0.24 0.025 245)",
                    boxShadow: isSelected ? "0 0 12px oklch(0.91 0.22 125 / 0.3)" : "none"
                  },
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          ...
                          color: p === "uber" ? "oklch(0.10 0 0)" : "oklch(0.98 0 0)"
                        },
                        children: p === "uber" ? "U" : p === "99" ? "99" : "iD"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: {
                          color: isSelected ? "oklch(0.91 0.22 125)" : "oklch(0.68 0.025 225)"
                        },
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "Lucro Líquido" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: "text-lg font-bold",
                      style: {
                        color: preview.net >= 0 ? "oklch(0.91 0.22 125)" : "oklch(0.65 0.22 22)"
                      },
                      children: formatBRL(preview.net)
                    }
                  )
                ]
              }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          style: {
            background: isValid ? "oklch(0.91 0.22 125)" : "oklch(0.19 0.026 245)",
      ...
      rides.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", "data-ocid": "ride.list", children: [...rides].reverse().map((ride, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        ...
                        color: ride.platform === "uber" ? "oklch(0.10 0 0)" : "oklch(0.98 0 0)"
                      },
                      children: ride.platform === "uber" ? "U" : ride.platform === "99" ? "99" : "iD"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: PLATFORM_LABELS[ride.platform] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: "text-xs",
                      style: { color: "oklch(0.68 0.025 225)" },
                      children: formatKm(ride.km)
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      color: ride.netProfit >= 0 ? "oklch(0.91 0.22 125)" : "oklch(0.65 0.22 22)"
                    },
                    children: formatBRL(ride.netProfit)
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium text-foreground", children: formatBRL(ride.grossValue) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
      ...
      rides.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-foreground mb-1", children: "Nenhuma corrida ainda" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "oklch(0.68 0.025 225)" }, children: "Adicione sua primeira corrida acima." })
          ]
        }
      )
    ] }),
...
function VehicleSetup({ initialConfig, onComplete }) {
  var _a2, _b2;
  const [vehicleType, setVehicleType] = reactExports.useState(
    (initialConfig == null ? void 0 : initialConfig.type) ?? "combustao"
  );
  const [energyPrice, setEnergyPrice] = reactExports.useState(
    ((_a2 = initialConfig == null ? void 0 : initialConfig.energyPrice) == null ? void 0 : _a2.toString()) ?? ""
  );
  const [consumption, setConsumption] = reactExports.useState(
    ((_b2 = initialConfig == null ? void 0 : initialConfig.consumption) == null ? void 0 : _b2.toString()) ?? ""
  );
  const costPerKm = energyPrice && consumption && Number.parseFloat(consumption) > 0 ? Number.parseFloat(energyPrice.replace(",", ".")) / Number.parseFloat(consumption.replace(",", ".")) : null;
  const handleSubmit = () => {
  ...
  const isValid = energyPrice && consumption && Number.parseFloat(consumption.replace(",", ".")) > 0 && Number.parseFloat(energyPrice.replace(",", ".")) > 0;
  const energyLabel = vehicleType === "combustao" ? "Preço por Litro (R$)" : "Preço por kWh (R$)";
  const consumptionLabel = vehicleType === "combustao" ? "Consumo Médio (km/L)" : "Consumo Médio (km/kWh)";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            style: { color: "oklch(0.68 0.025 225)" },
            children: "Lucro Real Motorista"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground mt-4", children: "Configurar Veículo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "oklch(0.68 0.025 225)" }, children: "Informe os dados do seu veículo para calcular o custo por km." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 px-5 pb-8 flex flex-col gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                style: {
                  background: vehicleType === "combustao" ? "oklch(0.72 0.18 55)" : "transparent",
                  color: vehicleType === "combustao" ? "oklch(0.10 0.01 55)" : "oklch(0.68 0.025 225)"
                },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: "flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold transition-all duration-200",
                style: {
                  background: vehicleType === "eletrico" ? "oklch(0.91 0.22 125)" : "transparent",
                  color: vehicleType === "eletrico" ? "oklch(0.14 0.04 125)" : "oklch(0.68 0.025 225)"
                },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: "oklch(0.16 0.022 242)",
            borderColor: costPerKm ? "oklch(0.91 0.22 125 / 0.3)" : "oklch(0.24 0.025 245)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "oklch(0.68 0.025 225)" }, children: "Custo por km:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-base font-bold",
                style: {
                  color: costPerKm ? "oklch(0.91 0.22 125)" : "oklch(0.68 0.025 225)"
                },
                children: costPerKm !== null ? formatBRL(costPerKm) : "R$ —"
              }
            )
          ]
        }
...
function App() {
  ...
  const [vehicleConfig, setVehicleConfig] = reactExports.useState(
    null
  );
  const [rides, setRides] = reactExports.useState([]);
  const [screenKey, setScreenKey] = reactExports.useState(0);
  reactExports.useEffect(() => {
    const savedVehicle = localStorage.getItem(VEHICLE_KEY);
    const savedRides = localStorage.getItem(RIDES_KEY);
    if (savedVehicle) {
      const config = JSON.parse(savedVehicle);
  ...
  const handleVehicleSetup = (config) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "theme-color", content: "#0B0F14" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col screen-enter", children: [
      ...
      screen === "ride" && vehicleConfig && /* @__PURE__ */ jsxRuntimeExports.jsx(
        RideEntry,
        {
          vehicleConfig,
          rides,
      ...
      screen === "summary" && vehicleConfig && /* @__PURE__ */ jsxRuntimeExports.jsx(
        DaySummary,
        {
          rides,
